      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 max-w-5xl mx-auto">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group p-6 bg-gradient-to-br from-white to-orange-50 rounded-2xl shadow-xl shadow-orange-100/50 hover:shadow-orange-200/50 transition-all duration-300"
            >
      ...
      <div id="pricing" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-white">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {pricingPlans.map((plan) => (
            <div
              key={plan.name}
              className="rounded-3xl border p-8 shadow-lg hover:shadow-xl transition-shadow bg-white"
            >
