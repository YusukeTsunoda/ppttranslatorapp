    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 pt-32 pb-16">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button asChild size="lg" variant="outline" className="w-48 text-lg font-semibold rounded-xl border-2 border-black text-black bg-white hover:bg-gray-100">
      ...
      <section id="features" className="w-full flex-1 flex flex-col items-center justify-center px-4 pb-24">
        <h2 className="text-3xl sm:text-4xl font-bold text-black mb-12 text-center">主な機能</h2>
        <div className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="flex flex-col items-center justify-between bg-gray-50 rounded-2xl p-8 shadow-none border border-gray-200 min-h-[260px] h-full"
            >
              <img
              ...
              <div className="flex items-center mb-2">
                ...
                <span className="text-lg text-black font-medium text-center">{feature}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="w-full flex-1 flex flex-col items-center justify-center px-4 pb-24">
        <h2 className="text-3xl sm:text-4xl font-bold text-black mb-12 text-center">料金プラン</h2>
        <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
          {plans.map((plan) => (
            ...
            >
              <h3 className="text-2xl font-bold text-black mb-2 tracking-tight">{plan.name}</h3>
              <div className="mb-8">
