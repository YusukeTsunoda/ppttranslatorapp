...
const mockTexts: TextItem[] = [
  ...
  },
  {
    ...
    translations: [
      { language: 'en', text: 'Sample Text 2' }
    ],
  },
  {
    id: 'text3',
...
// TextListコンポーネントを定義
const TextList = ({ texts, onTextSelect, selectedTextIndex, onTextHover, searchTerm, hideTranslated, selectedLanguage }: TextListProps) => (
