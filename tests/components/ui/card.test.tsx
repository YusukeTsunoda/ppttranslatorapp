...
describe('Card Components', () => {
  describe('Card', () => {
    ...
    it('カスタムクラス名を適用する', () => {
      render(<Card className="custom-card" data-testid="test-card">カードコンテンツ</Card>);
  ...
  describe('CardHeader', () => {
    ...
    it('カスタムクラス名を適用する', () => {
      render(<CardHeader className="custom-header" data-testid="test-header">ヘッダーコンテンツ</CardHeader>);
  ...
  describe('CardTitle', () => {
    ...
    it('カスタムクラス名を適用する', () => {
      render(<CardTitle className="custom-title" data-testid="test-title">カードタイトル</CardTitle>);
  ...
  describe('CardDescription', () => {
    ...
    it('カスタムクラス名を適用する', () => {
      render(<CardDescription className="custom-desc" data-testid="test-desc">カードの説明</CardDescription>);
  ...
  describe('CardContent', () => {
    ...
    it('カスタムクラス名を適用する', () => {
      render(<CardContent className="custom-content" data-testid="test-content">カードのコンテンツ</CardContent>);
  ...
  describe('CardFooter', () => {
    ...
    it('カスタムクラス名を適用する', () => {
      render(<CardFooter className="custom-footer" data-testid="test-footer">フッターコンテンツ</CardFooter>);
