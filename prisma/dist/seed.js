        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.translationHistory.createMany({
                            data: [
                                {
                                    id: (0, uuid_1.v4)(),
                                    userId: user.id,
                ...
                case 3:
                    ...
                    return [4 /*yield*/, prisma.usageStatistics.upsert({
                            where: {
                                userId_month_year: {
                                    userId: user.id,
                                    month: currentMonth,
                ...
                case 6: return [4 /*yield*/, _b.apply(_a, [(_c.data = (_d.password = _e.sent(),
                            _d.role = 'ADMIN',
                            _d.credits = 1000,
                            _d),
                            _c)])];
